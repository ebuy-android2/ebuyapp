 ...
 */
public class ChooseListProductAdapter extends ArrayAdapter<ProductData> {
    private Context context;
    public ChooseListProductAdapter(@NonNull Context context, int resource, @NonNull List<ProductData> objects) {
